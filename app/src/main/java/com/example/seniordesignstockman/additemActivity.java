...
public class additemActivity extends AppCompatActivity {
    ...
    public  void additem(){
        ...
        if(!TextUtils.isEmpty(itemnameValue)&&!TextUtils.isEmpty(itemcategoryValue)&&!TextUtils.isEmpty(itempriceValue)){
            ...
            itemprice.setText("");
            itembarcode.setText("");
            Toast.makeText(additemActivity.this,itemnameValue+" Eklendi",Toast.LENGTH_SHORT).show();
        }
        else {
            Toast.makeText(additemActivity.this,"Tüm alanları doldurun",Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void Logout()
    {
        ...
        Toast.makeText(additemActivity.this,"Çıkış BAŞARILI", Toast.LENGTH_SHORT).show();
